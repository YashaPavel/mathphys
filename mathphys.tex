...
\begin{mydef}
    ...
    \begin{aligned}
        U\big|_{\partial \Omega}=\phi - &\text{ условия Дирихле} \\
        \dfrac{\partial U}{\partial \nu} \bigg|_{\partial \Omega}=\phi - &\text{ условия Неймана} \\
        \bigg(\dfrac{\partial U}{\partial \nu}+\sigma(x)U\bigg)\bigg|_{\partial \Omega}=\phi - &\text{ условия Робена}
    \end{aligned}
\end{mydef}
 \begin{figure}[H]
        \centering
...
\[\begin{align}\sin\alpha_0\approx\dfrac{\partial U(t, x_0)}{\partial x}\\
\sin\alpha_1\approx\dfrac{\partial U(t, x_0+\dd x)}{\partial x}\end{align} \quad \Rightarrow \quad \sin\alpha_1-\sin\alpha_0=\dfrac{\partial^2 U(t,x_0)}{\partial x^2}\dd x\]
Получим знакомое волновое уравение: 
...
\[
I_n=\int\limits_{-1}^{1}(1-x^2)^n\dd x.
\]
