...
Мы имееем бесконечный набор положительных собстенных чисел $\lambda_n \xrightarrow[n\to0] \ +\infty$ и соответсвующих им собственных функций $y_n$, набор которых полон. Другими словами:$\forall f\in\L_2([a,b]),$ в разложении ряд сходиться, то есть $$\int\limits_{a}^{b}\Bigg|f(x)-\sum_{n=1}^{k}f_n(t)y_n(x)\Bigg|^2\dd x \xrightarrow{k \to \infty} 0 \quad \text{ в }\L_2([a,b])$$ или же:
