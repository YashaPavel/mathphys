...
\begin{mytheorem}
    Пусть \(\phi\in\C^2(\R), \,\,\psi\in\C(\R) \quad \Rightarrow \quad \exists! \,\,\, U\in\C^2([0, +\infty)\times R)\) - решения задачи \ref{volna} и формула Даламбера явялется выражением для него
\end{mytheorem}
Свойства решения: \\
1) Пусть $\psi\equiv0$: 
\begin{figure}[H]
